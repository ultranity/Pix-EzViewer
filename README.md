...
## 第三方规则数据 / Third-party rule data

| 数据 | 来源 | 许可 |
|------|------|------|
| WebView bypass 规则(`assets/bypass/cealing-host.json`) | [SpaceTimee/Cealing-Host](https://github.com/SpaceTimee/Cealing-Host) | **BSL-1.0**;完整声明见 `app/src/main/assets/bypass/NOTICE` |

- 该数据文件以 **Boost Software License 1.0 (BSL-1.0)** 分发,周边 Pix-EzViewer 源代码仍沿用项目本体 MIT 许可。
- 不打包任何站点 favicon。
